...
ctk.CTkLabel(username_frame_label, text="Usuario:").pack(fill='both', expand=True, padx=5, pady=5)
username_input = ctk.CTkEntry(username_frame_entry)
username_input.pack(fill='both', expand=True, padx=5, pady=5)

ctk.CTkLabel(password_frame_label, text="Contraseña:").pack(fill='both', expand=True, padx=5, pady=5)
...
ctk.CTkLabel(profile_frame_label, text="Perfil:").pack(fill='both', expand=True, padx=5, pady=5)
...
ctk.CTkLabel(version_frame_label, text="Versión:").pack(fill='both', expand=True, padx=5, pady=5)
...
ctk.CTkLabel(jvm_frame_label, text="Argumentos JVM:").pack(fill='both', expand=True, padx=5, pady=5)
jvm_input = ctk.CTkEntry(jvm_frame_entry)
jvm_input.pack(fill='both', expand=True, padx=5, pady=5)
jvm_input.insert(index=0, string=("-Xms4G -Xmx4G"))
...
ctk.CTkButton(save_profile_frame, text="Guardar Perfil", command=save_profile).pack(fill='both', expand=True, padx=5, pady=5)
ctk.CTkButton(launch_frame, text="Lanzar", command=launch).pack(fill='both', expand=True, padx=5, pady=5)
