...
def Apache_Start():
    ...
    Button_Apache = ctk.CTkButton(sidebar_panel2, text='Stop Apache', command=lambda: (Apache_Stop(process, Button_Apache)))
...
def Apache_Stop(process, button):
    ...
    # Itera por la lista de procesos
...
cpu_ram_frame.place(relx=0.75, rely=0.6, relwidth=0.2, relheight=0.35)
