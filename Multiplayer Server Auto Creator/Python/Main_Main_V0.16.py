...
# Al pulsar la X de la ventana se cerrara completamente todo proceso/subproceso que siga abierto 
...
# funcion para iniciar Server_Client_Chat.pyw 
def Chat_Launcher():
    # Carga la biblioteca de sistema
    shell32 = ctypes.windll.shell32

    # Ruta de la aplicación 
    app_path = "Server_Client_Chat.pyw"
...
# Funcion para instalar el servidro de Forge
