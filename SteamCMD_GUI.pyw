...
class SteamCMDApp(ctk.CTk):
    ...
    def create_tabs(self):
        ...
        self.update_install_tab = self.tabview.add("Actualizar/Instalar")
        self.run_server_tab = self.tabview.add("Servidor")
        self.console_tab = self.tabview.add("Consola")
    ...
    def create_update_install_tab(self):
        ...
        steamcmd_download = ctk.CTkButton(steamcmd_frame, text="Descargar SteamCMD", command=self.descargar_steamcmd)
        ...
        steamcmd_browse_button = ctk.CTkButton(steamcmd_frame, text="Buscar", command=self.browse_steamcmd)
        ...
        game_label = ctk.CTkLabel(server_frame, text="Juego")
        ...
        login_label = ctk.CTkLabel(login_frame, text="Usuario/Contraseña")
        ...
        self.anonymous_checkbox = ctk.CTkCheckBox(login_frame, text="Iniciar como Anonymous")
        ...
        server_path_label = ctk.CTkLabel(path_frame, text="Servidor Path")
        ...
        server_path_browse_button = ctk.CTkButton(path_frame, text="Buscar", command=self.browse_server_path)
        server_path_browse_button.pack(side='left', padx=5)
        
        self.validate_checkbox = ctk.CTkCheckBox(path_frame, text="Validar archivos")
        self.validate_checkbox.pack(side='left', padx=5)
        
        self.console_checkbox = ctk.CTkCheckBox(path_frame, text="Usar Consola")
        self.console_checkbox.pack(side='left', padx=5)
        
        update_install_button = ctk.CTkButton(path_frame, text="Actualizar/Instalar", command=self.update_install)
    ...
    def create_run_server_tab(self):
        ...
        srcds_browse_button = ctk.CTkButton(srcds_frame, text="Buscar", command=self.browse_srcds)
        ...
        game_label = ctk.CTkLabel(game_frame, text="Juego")
        game_label.pack(side='left', padx=5)
        ...
        self.custom_mod_checkbox = ctk.CTkCheckBox(game_frame, text="mod personalizado")
        self.custom_mod_checkbox.pack(side='left', padx=5)
        
        # Server Name
        server_name_label = ctk.CTkLabel(game_frame, text="Nombre del Servidor")
        ...
        # Map
        map_label = ctk.CTkLabel(game_frame, text="Mapa")
        ...
        max_players_label = ctk.CTkLabel(network_frame, text="Jugadores Máximos")
        ...
        # UDP Port
        udp_port_label = ctk.CTkLabel(network_frame, text="Puerto UDP")
        ...
        self.debug_mode_checkbox = ctk.CTkCheckBox(options_frame, text="Modo Debug")
        ...
        self.console_mode_checkbox = ctk.CTkCheckBox(options_frame, text="Modo Consola")
        self.console_mode_checkbox.pack(side='left', padx=5)
        
        self.insecure_checkbox = ctk.CTkCheckBox(options_frame, text="Inseguro")
        self.insecure_checkbox.pack(side='left', padx=5)
        
        self.disable_bots_checkbox = ctk.CTkCheckBox(options_frame, text="Desabilitar Bots")
        self.disable_bots_checkbox.pack(side='left', padx=5)
        
        self.dev_messages_checkbox = ctk.CTkCheckBox(options_frame, text="Mensajes Dev")
        ...
        profile_save = ctk.CTkButton(launch_frame, text="Guardar", command=self.save_profile)
        profile_save.pack(side='left', expand=True,padx=5)

        run_button = ctk.CTkButton(launch_frame, text="Ejecutar", command=self.run_server)
